                            ...
                            <div className="col-md-6">
                                <div className="boxOne">
                                    <h1 className="headerHomePage">
                                        EVER CONSIDERED LEARNING TO CODE AS A
                                        FORM TO REDUCE THE RECIDIVISM RATE IN
                                        UNITED STATES?
                                    </h1>
                                </div>
                            </div>
                            ...
                            <div className="col-md-12">
                                <div className="boxSeven">
                                    ...
                                    <h4>
                                        ...
                                        organizations that offer free mentorship
                                        and/or classes to learn a career skill
                                        in coding. The main goal that we are
                                        trying to accomplish is listing all
                                        these valuable resources in one central
                                        location to have them accessible for
                                        those who are re-entering society and
                                        ready to start their second chance in
                                        life.{" "}
                                    </h4>
                                </div>
                            </div>
